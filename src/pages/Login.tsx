...
import { login, setCurrentUser, type LoginCredentials } from '@/utils/auth';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success && result.user) {
        ...
        toast({
          title: "Welcome Back!",
          description: `Hi ${result.user.name}, you're successfully logged in.`,
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center px-4">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-1/4 left-1/4 w-80 h-80 bg-primary/5 rounded-full blur-3xl animate-float" style={{ animationDelay: '2s' }}></div>
      </div>
